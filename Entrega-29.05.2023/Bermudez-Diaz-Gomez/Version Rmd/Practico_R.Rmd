...
![](EjemploEjecucion.png)

**NOTA**: Es recomendable ***usar la version .Rmd*** - *Puede leer el fichero actual y a su vez ejecutar el código junto con su resultado*. Ver ejemplo de ejecución en la imagen superior.
